...
public class ReservaTableItemModel extends AbstractTableModel {
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        ClientResponse actualizado = service.path("rest").path("reserva/"+reserva.getReservaId().intValue()).type(MediaType.APPLICATION_XML).accept(MediaType.APPLICATION_XML).put(ClientResponse.class, reserva);
